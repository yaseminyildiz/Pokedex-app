            ...
            <div className="row align-items-center">
              <div className=" col-md-5">
                <img
                  ...
                  className="card-img-top rounded mx-auto mt-2 bg-light"
                />
              </div>
              <div className="col-md-7">
                ...
                <p className="pb-3">{this.state.description}</p>
                <div className="row align-items-center">
                ...
                <div className="row mt-3">
                  <div className="col-6">
                  <button className="btn btn-outline-success disabled mt-3 w-100">Capture Pokemon</button> 

                  </div>
                  <div className="col-6">
                  <button className="btn btn-outline-success disabled mt-3 w-100">Add to Favorite</button> 
